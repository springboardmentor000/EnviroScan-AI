...
RADIUS = 5000  # 5 km radius around each station (meters)
CITY   = "Vijayawada"
...
df.to_csv("vijayawada_physical_features.csv", index=False)
print("\n💾 Saved → vijayawada_osm_features.csv")
