...
date_from = "2026-02-01T00:00:00Z"  # Nov 1, 2025
date_to   = "2026-03-31T23:59:59Z"  # Mar 6, 2026 (today)
...
# ──────────────────────────────────────
def main():
    print("🚀 Hyderabad Hourly Air Quality (Somajiguda, Hyderabad - TSPCB + Zoo Park, Hyderabad - TSPCB)")
    print("=" * 55)
...
# Align timestamps to exact hour (important for merging with weather)
    ...
    df_wide.to_csv("hyderabad_airquality.csv", index=False)
    print(f"\n🎉 Saved {len(df_wide)} rows → 'hyderabad_airquality.csv'")
